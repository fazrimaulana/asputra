...
<!-- <script type="text/javascript" src="{{ url('backend/plugins/jQueryUI/jquery-ui.min.js') }}"></script> -->
...
<!-- <script type="text/javascript" src="{{ url('backend/plugins/raphael/raphael.min.js') }}"></script> -->
...
<script type="text/javascript" src="{{ url('/backend/plugins/moment/min/moment.min.js') }}"></script>
